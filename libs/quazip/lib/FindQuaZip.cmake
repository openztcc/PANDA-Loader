...
include("${CMAKE_CURRENT_LIST_DIR}/QuaZip-Qt6_SharedTargets.cmake")
...
elseif(6 EQUAL 4)
    ...
    message(FATAL_ERROR "Qt version QUAZIP_QT_MAJOR_VERSION=6 is unsupported")
endif()
...
if(OFF)
    find_dependency(Qt6 REQUIRED COMPONENTS BundledZLIB)
else()
...
check_required_components(QuaZip-Qt6)
